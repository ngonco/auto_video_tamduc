      ...
      try {
        const res = await fetch('/api/render/start', {
          ...
          body: JSON.stringify({
            ...
            fontFamily: tp.subtitleStyles?.fontFamily || localStorage.getItem('auto_video_subtitle_font_family') || 'Lexend',
            fontWeight: tp.subtitleStyles?.fontWeight || localStorage.getItem('auto_video_subtitle_font_weight') || 'bold',
            allCaps: tp.subtitleStyles?.allCaps !== undefined ? tp.subtitleStyles.allCaps : (localStorage.getItem('auto_video_subtitle_all_caps') !== null ? localStorage.getItem('auto_video_subtitle_all_caps') === 'true' : true),
